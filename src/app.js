...
function initTables(){
    let students = showTable('students');
    let htmlString = '<thead><tr><th>${student.id}</th><th>${student.name}</th><th>${student.surname}</th><th>${student.teamId}</th><th>${student.tasksIds}</th></tr></thead><tbody>';
    students.data.forEach(function(student){
